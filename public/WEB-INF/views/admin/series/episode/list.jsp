...
<div class="row" style="padding-top: 8px">
    ...
    <div class="col-md-6">
        <a href="<c:url value="/admin/series/${series.id}/episode/create" />" class="pull-right btn btn-default"
    ...
    <table class="table" style="background:#DDDDDD">
        ...
        <c:forEach var="episode" items="${episodeList}" varStatus="rowCounter">
            <tr class="${rowCounter.count % 2 == 0 ? 'even' : 'odd'}">
                <td>
                    <a href="<c:url value="/admin/series/${series.id}/episode/show/${episode.id}" />">${episode.title}</a>
                </td>
                <td>
                ...
                <td style="white-space: nowrap">
                    <a class="btn btn-default" style="padding: 0px 10px"
                       href="<c:url value="/admin/series/${series.id}/episode/edit/${episode.id}" />">Edit</a>
                    <a class="btn btn-default" style="padding: 0px 10px"
                       href="<c:url value="/admin/series/${series.id}/episode/delete/${episode.id}" />">Delete</a>
                </td>
            </tr>
        </c:forEach>
